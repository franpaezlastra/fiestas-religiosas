...
lon,
lat,
{ minlon, maxlon, minlat, maxlat, width, height, pad })
{
...
export function pinesSeparados(clusters) {
  const out = [];
...
export function clusterFiestas(fiestas) {
...
export function capituloLabel(capitulo) {
