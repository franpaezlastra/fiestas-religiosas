  ...
  return (
    <section>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <div className="mt-6 aspect-video w-full border-2 border-dashed border-azul-logo/40 bg-papel" />
      </div>
    </section>
  );
}
  ...
  return (
    <section>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <div className="mt-6 aspect-[4/3] w-full border-2 border-dashed border-azul-logo/40 bg-papel" />
      </div>
    </section>
  );
}
    ...
    <section>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <span className="border-2 border-dashed border-azul-logo px-4 py-3 text-azul-logo">
            Instagram
          </span>
          <span className="border-2 border-dashed border-azul-logo px-4 py-3 text-azul-logo">
            Facebook
